...
# ─── Photo Cache (vision.py) ────────────────────────────────
# Кэш результата распознавания фото по md5-хэшу содержимого изображения.
# TTL долгий (30 дней) — одно и то же фото блюда не меняет КБЖУ.

PHOTO_CACHE_TTL = 60 * 60 * 24 * 30
